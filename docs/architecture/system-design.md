...
| Email | ✅ MVP, **scoped** — `TASK_REMINDER`/`TASK_DUE_*` (W71) and the one-time AI Nudge due-proximity escalation only (W77). All other types stay in-app only. | nodemailer/SMTP (same as OTP) |
