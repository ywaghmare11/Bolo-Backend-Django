...
- [x] First vertical slice (Auth → Tasks) end-to-end against `docs/api/api-spec.md` — core lifecycle only (create/list/detail/edit/delete/accept/done-a/done-d/cancel/remind + minimal labels); subtasks, comments, evidence, voice recording, and full label CRUD are Phase 3
